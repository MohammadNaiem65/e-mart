...
export default function page() {
    const blog = {
        ...
        summary:
            'Artificial Intelligence is revolutionizing industries and daily life.',
        description:
            'AI technology is growing rapidly, influencing businesses, healthcare, and consumer applications...',
