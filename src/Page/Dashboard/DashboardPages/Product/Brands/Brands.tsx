...
import DataTableComponent from "../../../../../comps/OverviewCard/DataTable/DataTableComponent";
...
const Brands = () => {
  const breadcrumbItems = [
    { label: "Admin", link: "/" },
    { label: "Product", link: "/" },
    { label: "Brand List" }, // No link for the current page
  ];
  return (
    <div className="p-4 pt-3">
      ...
      <div className="card bg-base-100">
        <div className="flex flex-col sm:flex-row justify-between items-center card-header p-3">
          <h1 className="card-title text-3xl sm:mb-0 mb-3">Brands List</h1>
          <div>
            <Link to={"create"}>
